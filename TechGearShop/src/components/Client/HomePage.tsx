  ...
  return (
    <div className="space-y-10 pb-16">
      ...
      <section className="bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 rounded-xl border-2 border-orange-500/80 p-5 shadow-2xl relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 pt-5">
      ...
      {/* 7. Store Founder & Personal Touch Section */}
      <section className="bg-slate-50 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 rounded-xl p-6 md:p-8">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
          ...
          <div className="shrink-0 flex flex-col items-center text-center">
            <img
              ...
              className="w-20 h-20 md:w-24 md:h-24 rounded-full object-cover border-2 border-slate-200 dark:border-slate-700 shadow-2xs"
            />
            <h4 className="font-bold text-sm mt-3 text-slate-900 dark:text-slate-100">{storeMeta.founder.name}</h4>
          ...
          <div className="flex-1 space-y-3 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-1.5 text-xs font-semibold text-orange-600 dark:text-orange-400">
              <MessageSquare className="w-4 h-4" />
              <span>Lời nhắn từ Founder</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-1 text-xs font-medium text-slate-700 dark:text-slate-300">
              {storeMeta.founder.commitmentPoints.map((point, idx) => (
                <div key={idx} className="flex items-center gap-2 bg-white dark:bg-slate-800 px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-700/70 shadow-2xs">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0" />
                  <span className="text-[11px] leading-tight text-slate-800 dark:text-slate-200">{point}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {(brand.brand_philosophy || brand.hardware_selection_rule) && (
        <section className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800 shadow-2xs space-y-4">
          <div className="flex items-center gap-2 text-xs font-bold text-slate-800 dark:text-slate-200">
            <Cpu className="w-4 h-4 text-orange-600 dark:text-orange-400" />
            <span>Triết lý lựa chọn phần cứng</span>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {brand.brand_philosophy && (
              <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-lg border border-slate-200/80 dark:border-slate-700/60 space-y-1.5">
